...
compression algorithms described in `Section 7.2 <multimedia.html>`__,
...
edge-native applications at the end of `Chapter
2 <../direct/trend.html>`__, but what is perhaps more interesting is to
...
9.3 <../applications/infrastructure.html>`__. In the INT architecture,
...
in `Section 3.4 <../internetworking/impl.html>`__, but it has the
...
.. admonition::  Broader Perspective
   ...
   `Blockchain and a Decentralized Internet <../security/trend.html>`__.
