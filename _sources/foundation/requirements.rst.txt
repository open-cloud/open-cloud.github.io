...
the networking technologies covered in this book.
   ...
   between these two usages, which we’ll discuss later.
...
the other end of the pipe.
   ...
   channels. This is the essense of layering, the cornerstone of
   network architectures discussed in the next section.
